...
// GetPaymentMethod gets payment method by payment id
...
// GetPaymentIntent gets payment intent by payment id
...
func (c *Card) SubscribePlan(cust *stripe.Customer, plan, email, last4, cardType string) (*stripe.Subscription, error) {
